...
export default async function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center p-16">
      <Header 
        title="Temukan Bakat dan Kreatifitasmu" 
        description="Lorem ipsum, dolor sit amet consectetur adipisicing elit. Molestiae corporis a ex, reiciendis accusantium similique dolorum, numquam veniam ipsam, earum doloremque. Enim distinctio quidem aliquam perspiciatis animi natus ratione omnis!" 
      />
